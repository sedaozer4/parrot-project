...
class PostCard extends ConsumerWidget {
  ...
  //Bir gönderiyi silmek için kullanılır.
  void deletePost(WidgetRef ref, BuildContext context) async {
    ref.read(postControllerProvider.notifier).deletePost(post, context);
  }

  // Bir gönderiyi beğenmek için kullanılır.
  void upvotePost(WidgetRef ref) async {
    ref.read(postControllerProvider.notifier).upvote(post);
  }

  // Bir gönderiyi beğenmemek için kullanılır.
  void downvotePost(WidgetRef ref) async {
    ref.read(postControllerProvider.notifier).downvote(post);
  }

  //Bir gönderiye ödül vermek için kullanılır.
  void awardPost(WidgetRef ref, String award, BuildContext context) async {
    ref.read(postControllerProvider.notifier).awardPost(post: post, award: award, context: context);
  }

  //Kullanıcı profiline yönlendirmek için kullanılır.
  void navigateToUser(BuildContext context) {
    Routemaster.of(context).push('/u/${post.uid}');
  }

  //Topluluğna yönlendirmek için kullanılır.
  void navigateToCommunity(BuildContext context) {
    Routemaster.of(context).push('/r/${post.communityName}');
  }

  // Yorumlara yönlendirmek için kullanılır.
