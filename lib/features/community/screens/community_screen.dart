...
class CommunityScreen extends ConsumerWidget {
  ...
  //Moderatör araçları ekranına yönlendirmek için kullanılan bir işlevdir.
  void navigateToModTools(BuildContext context) {
    Routemaster.of(context).push('/mod-tools/$name');
  }

  //Bir topluluğa katılmak için kullanılan bir işlevdir.
  void joinCommunity(WidgetRef ref, Community community, BuildContext context) {
    ref.read(communityControllerProvider.notifier).joinCommunity(community, context);
  }

  //kullanıcı durumunu izler ve kullanıcının oturum açmış veya misafir olduğunu belirler.
  @override
